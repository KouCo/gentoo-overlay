...
EAPI=7
inherit flag-o-matic udev xdg-utils git-r3

DESCRIPTION="Separate utilities ebuild from upstream v4l-utils package"
HOMEPAGE="https://git.linuxtv.org/v4l-utils.git"
EGIT_REPO_URI="git://github.com/KouCo/v4l-utils-jp.git"
EGIT_BRANCH="devel"

LICENSE="GPL-2+ LGPL-2.1+"
SLOT="0"
KEYWORDS="~amd64 ~arm arm64 ~ppc64 ~sparc ~x86"
IUSE="+bpf opengl qt5 gconv"
...
RDEPEND=">=media-libs/libv4l-${PV}[jpeg]
	...
	>=virtual/jpeg-0-r2:0=
	bpf? ( virtual/libelf:= )
	gconv? ( =media-tv/v4l-utils-gconv-1.16.6 )
	!media-tv/v4l2-ctl
